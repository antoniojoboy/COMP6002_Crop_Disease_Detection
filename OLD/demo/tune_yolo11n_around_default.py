...
def objective(trial):
    ...
    lr0 = trial.suggest_loguniform('learning_rate', 0.00797, 0.0799)
    batch = int(trial.suggest_discrete_uniform('batch', 4, 28,4))
    weight_decay = trial.suggest_loguniform('weight_decay',0.0007,0.00085)
    momentum = trial.suggest_uniform('momentum', 0.6, 0.8)
